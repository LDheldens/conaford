# Generated by Django 3.2.2 on 2024-03-12 22:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carta_poder', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('boceto', models.ImageField(null=True, upload_to='acta/imagenes')),
                ('archivo_firmas', models.FileField(null=True, upload_to='acta/archivos/')),
