# Generated by Django 3.2.2 on 2024-03-14 15:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_predio', models.CharField(default='PHY-76567576', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('boceto_pdf', models.ImageField(null=True, upload_to='acta/archivos')),
                ('toma_predio_imagen', models.ImageField(null=True, upload_to='acta/imagenes')),
                ('documento_predio_pdf', models.ImageField(null=True, upload_to='acta/archivos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('izquierda_distancia', models.DecimalField(decimal_places=2, max_digits=10)),
                ('acta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colindancias', to='pos.acta')),
            ],
        ),
        migrations.AddField(
            model_name='acta',
